...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_ortho_4x12(
    ...
    KC_LEFT_CTRL,     KC_LEFT_ALT,    KC_LEFT_GUI,    MO(1),          MO(2),          KC_SPACE,       KC_SPACE,       MO(3),          MO(4),          KC_AUDIO_VOL_DOWN,  KC_AUDIO_VOL_UP,  KC_ENTER
  ),
  ...
  [_LAYER1] = LAYOUT_ortho_4x12(
    ...
    _______,          _______,        _______,        _______,        _______,        KC_LEFT_SHIFT,  KC_LEFT_SHIFT, _______,         _______,        _______,            _______,          _______
  ),
  ...
  [_LAYER3] = LAYOUT_ortho_4x12(
    ...
    _______,          _______,        _______,        _______,        _______,        ST_MACRO_9,     ST_MACRO_9,    _______,         _______,        _______,            _______,          _______
  ),

  [_LAYER4] = LAYOUT_ortho_4x12(
    _______,          _______,        _______,        _______,        _______,        _______,        _______,        _______,        KC_F13,         KC_F14,             KC_F15,           KC_F16,
    ...
    RGB_TOG,          _______,        _______,        _______,        _______,        _______,        _______,        _______,        _______,        KC_BRIGHTNESS_DOWN, KC_BRIGHTNESS_UP, _______
  ),
